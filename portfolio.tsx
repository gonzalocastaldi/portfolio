      ...
      <div className="max-w-2xl w-full">
        <div className="grid grid-cols-1 md:grid-cols-2 gap-8 items-center mb-12">
          <div className="flex justify-center md:justify-end">
            <div
              className="w-48 h-48 md:w-56 md:h-56 rounded-lg overflow-hidden border-2 border-slate-700 hover:border-slate-500 transition-colors"
              aria-hidden={false}
            >
              <img
                src={profileJpeg}
        ...
        <div className="flex flex-col sm:flex-row gap-4 justify-center mt-12">
          ...
          >
            <ExternalLink size={20} aria-hidden="true" focusable={false} />
          ...
          <a
            href="https://www.linkedin.com/in/gonzalocastaldi"
            target="_blank"
            rel="noopener noreferrer"
        ...
        <div className="text-center mt-16 text-slate-500 text-sm">
          <p>© 2025 Gonzalo Castaldi. Todos los derechos reservados.</p>
        </div>
      </div>
    </div>
  );
